# My utility codes
A variety of scripts implementing different aspects which I use from time to time in my coding. It's my storage for some implementations I find intersting and generally useful.
