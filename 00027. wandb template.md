# Minimal clean way to add W&B logging to my training scrips:
...
3b) You can use "wandb.log" multiple times in the code: 

        wandb.log({"train/loss": train_loss, "train/dist": train_dist}, step=epoch)
        wandb.log({"eval/loss":  eval_loss,  "eval/dist":  eval_dist},  step=epoch)

        ======================================================================================
        You can also log multiple times per epoch (use appropriate step, which is the x-axis):
        
        global_step = epoch * num_batches + batch_idx
        wandb.log({"train/loss": loss.item()}, step=global_step)


4) Finish once, at the end, after the whole train & evaluation:
